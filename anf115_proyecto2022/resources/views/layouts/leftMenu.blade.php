...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
         ...
         <div class="info">
            <a href="#" class="d-block">Solo William trabajaba</a>
         </div>
      </div>-->
      <!-- SidebarSearch Form
      ...
      <nav class="mt-2">
        ...
        --  <li class="nav-item">
        <a href="{{route('empresa_insert')}}" class="nav-link"><i class="nav-icon fas fa-building"></i>
          Agregar Empresa</a>
         </li>
         <li class="nav-item">
            <a class="nav-link" href="{{ URL::to('catalogos') }}"><i class="nav-icon fas fa-folder"></i>{{ __('Catalogo') }} </a>
            </a>
         </li>
         <section class="menu">
            @yield('menu')
